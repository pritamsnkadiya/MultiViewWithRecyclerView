package com.example.pritam.meenuapp.utils;
...
import com.example.pritam.meenuapp.init.ApplicationAppContext;
...
public class Methods {
    ...
    public static void showPromptMessage(String msg) {
        Toast.makeText(ApplicationAppContext.getAppContext(), msg, Toast.LENGTH_LONG).show();
    }
